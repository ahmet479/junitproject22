...
//        Radio button'larin elementlerini locate edin
        WebElement erkekSecenek = driver.findElement(By.xpath("//input[@type='radio'] and @value='2']"));
        WebElement kadinSecenek = driver.findElement(By.xpath("//input[@type='radio'] and @value='1']"));
        // Ardindan eger cinsiyet secili degilse radio button'a click ederek secin
        if (!erkekSecenek.isDisplayed()) {
            erkekSecenek.click();
        }
        // Sing Up buttonuna click edip hesap olusturun
